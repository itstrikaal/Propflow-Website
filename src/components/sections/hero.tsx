...
export function HeroSection() {
  ...
  return (
    <section className="relative overflow-hidden pb-8 pt-24 sm:pt-32 lg:pt-40" aria-label="Hero">
      {/* Background Effects */}
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute -left-1/4 top-0 h-[500px] w-[500px] rounded-full bg-brand-500/10 blur-[120px]" />
        <div className="absolute -right-1/4 bottom-0 h-[400px] w-[400px] rounded-full bg-brand-alt-500/8 blur-[100px]" />
      </div>
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          <div className="relative z-10">
            ...
            <motion.h1
              ...
              className="text-4xl font-bold leading-tight tracking-tight text-fg sm:text-5xl lg:text-6xl"
            >
              Your WhatsApp, CRM &{" "}
              <span className="gradient-text">Documents</span>.
              <br />
              One app for your brokerage.
            </motion.h1>
