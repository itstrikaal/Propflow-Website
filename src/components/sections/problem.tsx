      ...
      >
        {problems.map((problem) => (
          <motion.div
            ...
            className={cn(
              "group border-border bg-surface hover:border-border/80 rounded-2xl border p-6 transition-all duration-300 hover:shadow-lg"
            )}
          >
            <div
              className={cn(
            ...
            <h3 className="text-fg text-base font-semibold">{problem.title}</h3>
